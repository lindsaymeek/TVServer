...
# 1 "../src/app_device_msd.h" 1
# 35 "../src/app_device_msd.h"
void APP_DeviceMSDInitialize();
# 51 "../src/app_device_msd.h"
...
uint8_t tx_buffer_sizes[8] = { 2, 1, 0, 0, 0, 0, 0, 0 };
uint8_t rx_buffer_sizes[8] = { 16, 2, 0, 0, 0, 0, 0, 0 };
...
# 187 "../src/main.c"
            ...
            else
            {
                ...
                if((void*)pdata == ((0 == 0)?((void*)pBDTEntryOut[1u]):((void*)pBDTEntryIn[1u])))
                {
