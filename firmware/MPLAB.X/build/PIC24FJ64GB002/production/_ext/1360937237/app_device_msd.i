...
# 12 "../src/app_device_msd.c" 2

# 1 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 1 3 4
# 28 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
...
extern int errno;
# 29 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 2 3 4



# 1 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdarg.h" 1 3 4
...
# 33 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 2 3 4
# 57 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
...
# 78 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
extern struct _tfiles {
 char tname[81];
 struct _iobuf * tfp;
} * _tfilesptr;
# 258 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
...
# 302 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
extern void (*_atexitptr)(void);
# 335 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
...
# 391 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdio.h" 3 4
extern int sprintf(char *, const char *, ...);
extern int printf(const char *, ...);
# 14 "../src/app_device_msd.c" 2
...
# 14 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/string.h" 3 4
...
# 50 "../src/usb/usb.h" 2
# 16 "../src/app_device_msd.c" 2
# 1 "../../../../../../framework/usb/usb_device_hid.h" 1
# 102 "../../../../../../framework/usb/usb_device_hid.h"
void USBCheckHIDRequest(void);
# 284 "../../../../../../framework/usb/usb_device_hid.h"
...
# 18 "../src/app_device_msd.c" 2

# 1 "../src/ethernet/socket.h" 1
# 81 "../src/ethernet/socket.h"
# 1 "../src/Ethernet/wizchip_conf.h" 1
# 54 "../src/Ethernet/wizchip_conf.h"
# 1 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdint.h" 1 3 4
...
# 82 "../src/ethernet/socket.h" 2
# 147 "../src/ethernet/socket.h"
int8_t socket(uint8_t sn, uint8_t protocol, uint16_t port, uint8_t flag);
# 159 "../src/ethernet/socket.h"
int8_t close(uint8_t sn);
# 172 "../src/ethernet/socket.h"
int8_t listen(uint8_t sn);
# 195 "../src/ethernet/socket.h"
int8_t connect(uint8_t sn, uint8_t * addr, uint16_t port);
# 212 "../src/ethernet/socket.h"
int8_t disconnect(uint8_t sn);
# 232 "../src/ethernet/socket.h"
int32_t send(uint8_t sn, uint8_t * buf, uint16_t len);
# 254 "../src/ethernet/socket.h"
int32_t recv(uint8_t sn, uint8_t * buf, uint16_t len);
# 282 "../src/ethernet/socket.h"
int32_t sendto(uint8_t sn, uint8_t * buf, uint16_t len, uint8_t * addr, uint16_t port);
# 312 "../src/ethernet/socket.h"
int32_t recvfrom(uint8_t sn, uint8_t * buf, uint16_t len, uint8_t * addr, uint16_t *port);
# 330 "../src/ethernet/socket.h"
typedef enum
{
   SIK_CONNECTED = (1 << 0),
...
# 399 "../src/ethernet/socket.h"
int8_t ctlsocket(uint8_t sn, ctlsock_type cstype, void* arg);
# 427 "../src/ethernet/socket.h"
int8_t setsockopt(uint8_t sn, sockopt_type sotype, void* arg);
# 459 "../src/ethernet/socket.h"
int8_t getsockopt(uint8_t sn, sockopt_type sotype, void* arg);
# 20 "../src/app_device_msd.c" 2
# 1 "../src/ataoe.h" 1
# 12 "../src/ataoe.h"
# 1 "c:\\program files\\microchip\\xc16\\v1.21\\bin\\bin\\../..\\include/stdint.h" 1 3 4
# 13 "../src/ataoe.h" 2
...
static _Bool config_active,read_active;

static uint8_t retries;
# 49 "../src/app_device_msd.c"
...
static void inline sendtoraw(uint8_t * buf, uint16_t len)
{
   ...
   while(1)
   {
      ...
      if(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*0) << 3))) == 0x00) return ;
      if(len <= freesize) break;
   };

   wiz_send_data(0, buf, len);

  WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)), 0x20);

  while(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3))));
}
...
void debug(const char *format,...)
{
 ...
 args=(void *) __builtin_next_arg (format);

 if(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*1) << 3)))==0x00)
 {
     close(1);

     if(1==socket(1,0x01,23,0))
     {
         listen(1);
     }
 ...
 if(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*1) << 3)))==0x17)
 {
...
uint32_t last_lba;
# 130 "../src/app_device_msd.c"
_Bool read_net(uint32_t lba,uint8_t *sector_buffer)
{
    uint8_t head[2];
    uint32_t tip ;
    uint16_t pack_len,remain_len;
    _Bool ok=0;
# 146 "../src/app_device_msd.c"
    if(cache_lba == lba)
    {
        LATBbits.LATB15=1;


        WIZCHIP_READ_BUF(cache_addr, sector_buffer, 512);
    ...
    if(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*0) << 3)))==0x00)
    {
            close(0);

            socket(0,0x04,0,(0x80)|(0x10)|(0x20));


            debug("Open AOE socket\n\r");

            WIZCHIP_READ_BUF((0x00000000L + (0x0009 << 8) + (0x00 << 3)), client_mac, 6);

            return 0;
    }


                pack_len = getSn_RX_RSR(0);
        ...
        WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)), 0x40);
                   remain_len = head[0];
        remain_len <<= 8;
                   remain_len |= head[1];
                   remain_len -= 2;
...
# 220 "../src/app_device_msd.c"
                   if(remain_len >= sizeof(ataoe.header))
                   {

                    wiz_recv_data(0,(void *)&ataoe.header,sizeof(ataoe.header));
                    WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)), 0x40);
                    remain_len -= sizeof(ataoe.header);
                    while(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)))) ;


                    if((swap(ataoe.header.msg_type) == 0x88a2) && ((ataoe.header.flags & 0x18)==0x18))
                    {



                    if((ataoe.header.cmd == 1) )
                    {
                        ...
                        if(remain_len >= sizeof(ataoe.body.cfg))
                        {
                            ...
                            wiz_recv_data(0,(void *)&ataoe.body.cfg,sizeof(ataoe.body.cfg));
                            WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)), 0x40);
                            ...
                            ataoe_rd.header.msg_type = swap(0x88a2);
                    ...
                    else if((ataoe.header.cmd == 0))
                    {
                        ...
                        if((ataoe.header.major == server_major) && (ataoe.header.minor == server_minor))
                        {
                            ...
                            if(remain_len >= sizeof(ataoe.body.iss))
                            {
                                ...
                                wiz_recv_data(0,(void *)&ataoe.body.iss,sizeof(ataoe.body.iss));
                                WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)), 0x40);
                                ...
                                if(ataoe.body.iss.err==0)
                                {
                                    ...
                                    if(ataoe.header.tag == read_tag)
                                    {
                                     ...
                                     if((remain_len >= 512) && (sector_buffer!=((void *)0)))
                                     {

                                        wiz_recv_data(0,sector_buffer,512);
                                        WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*0) << 3)), 0x40);
                                        remain_len -= 512;
                                        retries=0;
                                        ok=1;
                                     ...
                                     if(remain_len >= 512)
                                     {
                                         ...
                                         cache_addr = ((WIZCHIP_READ((0x00000000L + (0x0028 << 8) + ((1+4*0) << 3))) << 8) + WIZCHIP_READ(((0x00000000L + (0x0028 << 8) + ((1+4*0) << 3)) + (1<<8))));
                                         cache_addr <<= 8;
                                         cache_addr += (3+4*0) << 3;
            ...
            else
            {
                ...
                if(server_major==0xFFFFu && server_minor==0xFF)
                {
                    ...
                    if(!config_active)
                    {
                        ...
                        ataoe.header.msg_type = swap(0x88a2);
                    ...
                    {
                        if((ReadTicker() - config_timeout) >= 1000)
                        {
                   ...
                   if(!read_active)
                   {
                    ...
                    else
                    {
                        ...
                        if(read_active)
                        {
                            ...
                            if((ReadTicker()-read_timeout) >= 5000)
                            {
...
# 611 "../src/app_device_msd.c"
LUN_FUNCTIONS LUN[0u + 1] =
{
    {
        ...
        (_Bool (*)(void *))&FILEIO_NET_MediaDetect,
...
# 658 "../src/app_device_msd.c"
void APP_DeviceMSDInitialize()
{

        USBEnableEndpoint(1u,0x04|0x08|0x01|0x10);
