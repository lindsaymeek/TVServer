...
static uint16_t sock_remained_size[8] = {0,0,0,0,0,0,0,0};
static uint8_t sock_pack_info[8] = {0,0,0,0,0,0,0,0};
# 82 "../src/Ethernet/socket.c"
int8_t socket(uint8_t sn, uint8_t protocol, uint16_t port, uint8_t flag)
{
 ...
 close(sn);
 WIZCHIP_WRITE((0x00000000L + (0x0000 << 8) + ((1+4*sn) << 3)),(protocol | (flag & 0xF0)));
 if(!port)
 {
    port = sock_any_port++;
    if(sock_any_port == 0xFFF0) sock_any_port = 0xC000;;
 }
   { WIZCHIP_WRITE((0x00000000L + (0x0004 << 8) + ((1+4*sn) << 3)), (uint8_t)(port >> 8)); WIZCHIP_WRITE(((0x00000000L + (0x0004 << 8) + ((1+4*sn) << 3)) + (1<<8)), (uint8_t) port); };
   WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x01);
   while(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3))));
...
int8_t close(uint8_t sn)
{
 ...
 WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x10);

 while( WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3))) );

 WIZCHIP_WRITE((0x00000000L + (0x0002 << 8) + ((1+4*sn) << 3)), (0xFF & 0x1F));
 sock_is_sending &= ~(1<<sn);
 sock_remained_size[sn] = 0;
 sock_pack_info[sn] = 0;
 while(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3))) != 0x00);
 return 1;
}
...
{
 do{ if(sn > 8) return (0 - 1); }while(0);;
   do{ if((WIZCHIP_READ((0x00000000L + (0x0000 << 8) + ((1+4*sn) << 3))) & 0x0F) != 0x01) return (0 - 5); }while(0);;
 do{ if((WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3))) != 0x13)) return (0 - 3); }while(0);;
 WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x02);
 while(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3))));
   while(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3))) != 0x14)
   {
      if(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3))) == 0x00)
      {
         close(sn);
         return (0 - 4);
      }
...
int8_t connect(uint8_t sn, uint8_t * addr, uint16_t port)
{
   ...
   do{ if((WIZCHIP_READ((0x00000000L + (0x0000 << 8) + ((1+4*sn) << 3))) & 0x0F) != 0x01) return (0 - 5); }while(0);;
   do{ if((WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3))) != 0x13)) return (0 - 3); }while(0);;
 if( *((uint32_t*)addr) == 0xFFFFFFFF || *((uint32_t*)addr) == 0) return (0 - 12);
 if(port == 0) return (0 - 11);
 WIZCHIP_WRITE_BUF((0x00000000L + (0x000C << 8) + ((1+4*sn) << 3)), addr, 4);
 { WIZCHIP_WRITE((0x00000000L + (0x0010 << 8) + ((1+4*sn) << 3)), (uint8_t) (port>>8)); WIZCHIP_WRITE(((0x00000000L + (0x0010 << 8) + ((1+4*sn) << 3)) + (1<<8)), (uint8_t) port); };



 WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x04);
   while(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3))));
   if(sock_io_mode & (1<<sn)) return 0;
   while(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3))) != 0x17)
   {
  if ((WIZCHIP_READ((0x00000000L + (0x0002 << 8) + ((1+4*sn) << 3))) & 0x1F) & 0x08)
  {
   WIZCHIP_WRITE((0x00000000L + (0x0002 << 8) + ((1+4*sn) << 3)), (0x08 & 0x1F));
...
int8_t disconnect(uint8_t sn)
{
   do{ if(sn > 8) return (0 - 1); }while(0);;
   do{ if((WIZCHIP_READ((0x00000000L + (0x0000 << 8) + ((1+4*sn) << 3))) & 0x0F) != 0x01) return (0 - 5); }while(0);;
 WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x08);
...
int32_t send(uint8_t sn, uint8_t * buf, uint16_t len)
{
   ...
   tmp = WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3)));
   if(tmp != 0x17 && tmp != 0x1C) return (0 - 7);
   if( sock_is_sending & (1<<sn) )
   {
      tmp = (WIZCHIP_READ((0x00000000L + (0x0002 << 8) + ((1+4*sn) << 3))) & 0x1F);
      if(tmp & 0x10)
      {
         WIZCHIP_WRITE((0x00000000L + (0x0002 << 8) + ((1+4*sn) << 3)), (0x10 & 0x1F));
# 258 "../src/Ethernet/socket.c"
         sock_is_sending &= ~(1<<sn);
      }
      else if(tmp & 0x08)
      {
   ...
   freesize = (WIZCHIP_READ((0x00000000L + (0x001F << 8) + ((1+4*sn) << 3))) << 10);
   ...
   WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x20);
...
int32_t recv(uint8_t sn, uint8_t * buf, uint16_t len)
{
   ...
   recvsize = (WIZCHIP_READ((0x00000000L + (0x001E << 8) + ((1+4*sn) << 3))) << 10);
   ...
   while(1)
   {
      ...
      if (tmp != 0x17)
      {
         ...
         {
            if(recvsize != 0) break;
            else if(getSn_TX_FSR(sn) == (WIZCHIP_READ((0x00000000L + (0x001F << 8) + ((1+4*sn) << 3))) << 10))
            {
               close(sn);
               return (0 - 7);
            }
   ...
   WIZCHIP_WRITE((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3)), 0x40);
   while(WIZCHIP_READ((0x00000000L + (0x0001 << 8) + ((1+4*sn) << 3))));
   return len;
}
...
int32_t sendto(uint8_t sn, uint8_t * buf, uint16_t len, uint8_t * addr, uint16_t port)
{
   ...
   uint16_t freesize = 0;
   do{ if(sn > 8) return (0 - 1); }while(0);;
   switch(WIZCHIP_READ((0x00000000L + (0x0000 << 8) + ((1+4*sn) << 3))) & 0x0F)
   {
      case 0x02:
      case 0x04:
         break;
   ...
   do{ if(len == 0) return (0 - 14); }while(0);;
   if(*((uint32_t*)addr) == 0) return (0 - 12);
   if(port == 0) return (0 - 11);
   tmp = WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3)));
   if(tmp != 0x42 && tmp != 0x22) return (0 - 7);
   ...
   {
      freesize = getSn_TX_FSR(sn);
      if(WIZCHIP_READ((0x00000000L + (0x0003 << 8) + ((1+4*sn) << 3))) == 0x00) return (0 - 4);
      if( (sock_io_mode & (1<<sn)) && (len > freesize) ) return 0;
      if(len <= freesize) break;
   };
 wiz_send_data(sn, buf, len);
...
int32_t recvfrom(uint8_t sn, uint8_t * buf, uint16_t len, uint8_t * addr, uint16_t *port)
{
 ...
 uint16_t pack_len=0;
   ...
   switch((mr=WIZCHIP_READ((0x00000000L + (0x0000 << 8) + ((1+4*sn) << 3)))) & 0x0F)
   {
      case 0x02:
      case 0x04:
         break;
...
int32_t recvflush(uint8_t sn)
{
    if(sock_remained_size[sn] != 0)
        return recvfrom(sn, (void *)0, sock_remained_size[sn], (void *)0, (void *)0);
    else
        return 0;
}
