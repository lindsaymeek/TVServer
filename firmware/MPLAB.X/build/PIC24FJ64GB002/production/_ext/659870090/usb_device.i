...
# 50 "../src/usb/usb.h" 2
# 57 "../src/usb/usb_device.c" 2


# 1 "../../../../../../framework/usb/src/usb_device_local.h" 1
# 36 "../../../../../../framework/usb/src/usb_device_local.h"
# 1 "../src/system_config.h" 1
# 37 "../../../../../../framework/usb/src/usb_device_local.h" 2
# 49 "../../../../../../framework/usb/src/usb_device_local.h"
typedef union
{
    struct
    {
...
# 63 "../src/usb/usb_device.c" 2
# 109 "../src/usb/usb_device.c"
typedef union
{
    uint8_t Val;
    struct __PACKED
...
void USBDeviceInit(void)
{
    ...
    memset((void*)&U1EP1,0x00,(1 * 2));;

    { U1CNFG1 = 0x02; U1CNFG2 = 0x00; U1OTGCONbits.OTGEN = 0;; U1EIE = 0x9F; U1IE = 0x99 | 0x04 | 0x02; };


    U1PWRCbits.USBPWR = 1;;


    U1BDTP1 = (((unsigned int)BDT)/256);;
...
# 483 "../src/usb/usb_device.c"
void USBDeviceTasks(void)
{
    uint8_t i;
# 597 "../src/usb/usb_device.c"
    if(USBDeviceState == ATTACHED_STATE)
    {
# 608 "../src/usb/usb_device.c"
        if(!U1CONbits.SE0)
        {
            U1IR = 0xFFFF;;
...
# 1024 "../src/usb/usb_device.c"
    ...
    if(dir != 0)
    {
        ...
        {((uint8_t_VAL*)&pBDTEntryIn[ep])->Val ^= 0x0004;};
    }
    else
    {

        {((uint8_t_VAL*)&pBDTEntryOut[ep])->Val ^= 0x0004;};
    }
    return (void*)handle;
}
# 1068 "../src/usb/usb_device.c"
void USBStallEndpoint(uint8_t ep, uint8_t dir)
{
    BDT_ENTRY *p;
...
void USBCancelIO(uint8_t endpoint)
{
    if(U1CONbits.PKTDIS == 1)
    {
     ...
     pBDTEntryIn[endpoint]->Val ^= 0x40;
        ...
        {((uint8_t_VAL*)&pBDTEntryIn[endpoint])->Val ^= 0x0004;};
...
void USBDeviceDetach(void)
{
...

    {
         ...
         USBDeviceState = DETACHED_STATE;
# 1286 "../src/usb/usb_device.c"
          return;
    }
# 1307 "../src/usb/usb_device.c"
}
# 1347 "../src/usb/usb_device.c"
void USBDeviceAttach(void)
{
...
static void USBConfigureEndpoint(uint8_t EPNum, uint8_t direction)
{
    ...
    else
    {
        ...
        handle->STAT.DTS = 0;
        (handle+1)->STAT.DTS = 1;
# 1580 "../src/usb/usb_device.c"
}
# 1611 "../src/usb/usb_device.c"
static void USBCtrlEPServiceComplete(void)
{
...
# 1680 "../src/usb/usb_device.c"
   if(USBDeferINDataStagePackets == 0)
            {
                USBCtrlEPAllowDataStage();
   }
# 1705 "../src/usb/usb_device.c"
            USBStatusStageEnabledFlag2 = 0;
            USBStatusStageEnabledFlag1 = 0;
...
static void USBCtrlTrfRxService(void)
{
    ...
    else
    {
        ...
        {
# 1919 "../src/usb/usb_device.c"
                outPipes[0].pFunc();

        }
        outPipes[0].info.bits.busy = 0;
# 1936 "../src/usb/usb_device.c"
        if(USBDeferStatusStagePacket == 0)
        {
            USBCtrlEPAllowStatusStage();
        }
...
# 2197 "../src/usb/usb_device.c"
static void USBStallHandler(void)
{
# 2209 "../src/usb/usb_device.c"
...
# 2240 "../src/usb/usb_device.c"
static void USBSuspend(void)
{
# 2265 "../src/usb/usb_device.c"
...
# 2317 "../src/usb/usb_device.c"
    U1OTGIEbits.ACTVIE = 0;
# 2337 "../src/usb/usb_device.c"
    {
        (U1OTGIR = (1 << 4));
    }

}
# 2364 "../src/usb/usb_device.c"
static void USBCtrlEPService(void)
{
    ...
    if((USTATcopy.Val & ~0x04) == 0x00)
    {
        ...
        ((uint8_t_VAL*)&pBDTEntryEP0OutNext)->Val ^= 0x0004;
        ...
        if(pBDTEntryEP0OutCurrent->STAT.PID == 0xD)
        {
            ...
            {
                *(uint8_t*)((uint8_t*)&SetupPkt + setup_cnt) = *(uint8_t*)((void *)(pBDTEntryEP0OutCurrent->ADR));
...
# 2483 "../src/usb/usb_device.c"
    pBDTEntryIn[0]->STAT.Val &= ~(0x80);
    ((uint8_t_VAL*)&pBDTEntryIn[0])->Val ^= 0x0004;
    pBDTEntryIn[0]->STAT.Val &= ~(0x80);
    ((uint8_t_VAL*)&pBDTEntryIn[0])->Val ^= 0x0004;
    pBDTEntryEP0OutNext->STAT.Val &= ~(0x80);
...
# 2512 "../src/usb/usb_device.c"
    USBCtrlEPServiceComplete();
}
# 2536 "../src/usb/usb_device.c"
static void USBCtrlTrfOutHandler(void)
{
    if(controlTransferState == 2)
    {
