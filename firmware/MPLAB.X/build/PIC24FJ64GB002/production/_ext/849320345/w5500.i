...
# 47 "../src/Ethernet/W5500/w5500.c" 2
# 56 "../src/Ethernet/W5500/w5500.c"
uint8_t dummy;
...
void WIZCHIP_WRITE(uint32_t AddrSel, uint8_t wb )
{
    ;
    LATBbits.LATB0=0;
# 104 "../src/Ethernet/W5500/w5500.c"
    SPI1BUF=(uint8_t)(AddrSel >> 16);
    SPI1BUF=(uint8_t)(AddrSel >> 8);
    SPI1BUF=(0x01 << 2) | (uint8_t)AddrSel ;
    SPI1BUF = wb;
...
void WIZCHIP_READ_BUF (uint32_t AddrSel, register uint8_t* pBuf, uint16_t len)
{
   ...
   LATBbits.LATB0=0;
    ...
    SPI1BUF=(uint8_t)AddrSel ;
    SPI1BUF = 0;
# 157 "../src/Ethernet/W5500/w5500.c"
      BUFFER_ADDR = pBuf;
      BUFFER_LEN=len;
      BUFFER_READ();
# 218 "../src/Ethernet/W5500/w5500.c"
   LATBbits.LATB0=1;
   ;
}
...
void WIZCHIP_WRITE_BUF(uint32_t AddrSel, uint8_t* pBuf, uint16_t len)
{
   ...
   LATBbits.LATB0=0;
    ...
    BUFFER_LEN=len;
    BUFFER_WRITE();
# 260 "../src/Ethernet/W5500/w5500.c"
   LATBbits.LATB0=1;
   ;
}
...
uint16_t getSn_TX_FSR(uint8_t sn)
{
   ...
   do
   {
      val1 = WIZCHIP_READ((0x00000000L + (0x0020 << 8) + ((1+4*sn) << 3)));
      val1 = (val1 << 8) + WIZCHIP_READ(((0x00000000L + (0x0020 << 8) + ((1+4*sn) << 3)) + (1<<8)));
      if (val1 != 0)
      {
        val = WIZCHIP_READ((0x00000000L + (0x0020 << 8) + ((1+4*sn) << 3)));
        val = (val << 8) + WIZCHIP_READ(((0x00000000L + (0x0020 << 8) + ((1+4*sn) << 3)) + (1<<8)));
      }
   }while (val != val1);
   return val;
}
...
uint16_t getSn_RX_RSR(uint8_t sn)
{
   ...
   do
   {
      val1 = WIZCHIP_READ((0x00000000L + (0x0026 << 8) + ((1+4*sn) << 3)));
      val1 = (val1 << 8) + WIZCHIP_READ(((0x00000000L + (0x0026 << 8) + ((1+4*sn) << 3)) + (1<<8)));
      if (val1 != 0)
      {
        val = WIZCHIP_READ((0x00000000L + (0x0026 << 8) + ((1+4*sn) << 3)));
        val = (val << 8) + WIZCHIP_READ(((0x00000000L + (0x0026 << 8) + ((1+4*sn) << 3)) + (1<<8)));
      }
   }while (val != val1);
   return val;
}
...
void wiz_send_data(uint8_t sn, uint8_t *wizdata, uint16_t len)
{
   ...
   uint32_t addrsel = 0;
   if(len == 0) return;
   ptr = ((WIZCHIP_READ((0x00000000L + (0x0024 << 8) + ((1+4*sn) << 3))) << 8) + WIZCHIP_READ(((0x00000000L + (0x0024 << 8) + ((1+4*sn) << 3)) + (1<<8))));

   addrsel = ((uint32_t)ptr << 8) + ((2+4*sn) << 3);
   WIZCHIP_WRITE_BUF(addrsel,wizdata, len);

   ptr += len;
   { WIZCHIP_WRITE((0x00000000L + (0x0024 << 8) + ((1+4*sn) << 3)), (uint8_t)(ptr>>8)); WIZCHIP_WRITE(((0x00000000L + (0x0024 << 8) + ((1+4*sn) << 3)) + (1<<8)), (uint8_t) ptr); };
}
...
void wiz_recv_data(uint8_t sn, uint8_t *wizdata, uint16_t len)
{
   ...
   if(len == 0) return;
   ptr = ((WIZCHIP_READ((0x00000000L + (0x0028 << 8) + ((1+4*sn) << 3))) << 8) + WIZCHIP_READ(((0x00000000L + (0x0028 << 8) + ((1+4*sn) << 3)) + (1<<8))));
   ...
   { WIZCHIP_WRITE((0x00000000L + (0x0028 << 8) + ((1+4*sn) << 3)), (uint8_t)(ptr>>8)); WIZCHIP_WRITE(((0x00000000L + (0x0028 << 8) + ((1+4*sn) << 3)) + (1<<8)), (uint8_t) ptr); };
}
